<script lang="ts">
	import SidebarLeft from "$lib/blocks/sidebar-15/components/sidebar-left.svelte";
	import SidebarRight from "$lib/blocks/sidebar-15/components/sidebar-right.svelte";
